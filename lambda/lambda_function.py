...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        # display_directive = RenderDocumentDirective(token="pagerToken",document=_load_apl_document("launchDocument.json"),datasources=_load_apl_document("launchDataSources.json"))
        displayDirective = RenderDocumentDirective(
                            token="pagerToken",
                            document=_load_apl_document("documents/display_template.json"),
                            datasources=_load_apl_document("documents/launchPageData.json")
                            )
